const flowConfig = {
  "id": "bdbf0518-84ab-4805-8538-24225789cd23",
  "name": "Nutty Van",
  "edges": [
    {
  ...
  "status": "active",
  "created_at": "2025-06-12T12:52:14.720216+00:00",
  "trigger_id": null,
  "nodes": [
    {
    ...
    },
    {
      ...
      "data": {
        ...
        "values": {
          ...
          "content": "{{codeNode_845.output.results[:].content}}",
