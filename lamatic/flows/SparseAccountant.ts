const flowConfig = {
  "id": "9be34987-cf1e-4aac-957e-66b0fac140ee",
  "name": "Sparse Accountant",
  "edges": [
    {
  ...
  "status": "active",
  "created_at": "2025-06-07T03:50:20.968364+00:00",
  "trigger_id": null,
  "nodes": [
    {
      "id": "triggerNode_1",
    ...
    },
    {
      ...
      "data": {
        "nodeId": "scraperNode",
        "values": {
          "url": "https://support.samespace.com/start-using-samespace",
          "mobile": false,
          "waitFor": "1000",
          "nodeName": "Scraper",
          "credentials": "asdasdasd",
          "excludeTags": [],
          "includeTags": [],
